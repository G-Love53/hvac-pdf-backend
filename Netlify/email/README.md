# HVAC Insurance Direct — Instantly email creatives

Hosted on **hvacinsurancedirect.com** via `hvac-pdf-backend/Netlify/email/`.
...
| **JPEG** | `CID_HVAC_Creative.jpg` |
| **Instantly HTML** | `instantly_step3.html` |
| **Public JPEG URL** | https://hvacinsurancedirect.com/email/archive/2026-08-connect-v1/CID_HVAC_Creative.jpg |
...
node scripts/generate-instantly-email.mjs --segment hvac --version 2026-08-connect-v1
node scripts/extract-creative-jpg.mjs \
  --input ~/Downloads/CID_Creative_Hvac_Embedded.html \
  --output ~/GitHub/hvac-pdf-backend/Netlify/email/archive/2026-08-connect-v1/CID_HVAC_Creative.jpg
```
